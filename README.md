...
```
bash <(curl -Ls https://raw.githubusercontent.com/Besharatnia/x-ui/master/install.sh)
```

## 手动安装&升级

1. 首先从 https://github.com/Besharatnia/x-ui/releases 下载最新的压缩包，一般选择 `amd64`架构
...
[![Stargazers over time](https://starchart.cc/Besharatnia/x-ui.svg)](https://starchart.cc/Besharatnia/x-ui)
